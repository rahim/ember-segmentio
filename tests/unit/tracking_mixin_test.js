var ObjectWithMixin = Ember.Object.extend(Ember.SegmentioMixin);
...
test("logs page views sent to Segment.io", function() {
  expect(1);
...
test("logs events sent to Segment.io", function() {
  expect(1);
...
test("does not log page views sent to Segment.io", function() {
  expect(1);
...
test("does not log events sent to Segment.io", function() {
  expect(1);
